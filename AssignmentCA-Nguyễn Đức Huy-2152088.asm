...
ERROR: .asciiz "\nYou can't place a piece at this position. Please enter the instruction again \n"
ERRORKEY: .asciiz "\nThe instruction is inappropriate. Please enter the instruction again \n"
...
firstInstruction1:
	...
	lb $t2, ($t1)
	addi $t4, $s0, 38
loopFirstMoveplayer1:
	lb $t5, ($t4)
	beq $t5, '*', outloopFirstMoveplayer1
	addi $t4, $t4, -7
outloopFirstMoveplayer1:
	sb $t2, ($t4)
	li $v0, 3
	jr $ra
...
firstInstruction2:
	...
	lb $t2, ($t1)
	addi $t4, $s0, 31
loopFirstMoveplayer2:
	lb $t5, ($t4)
	beq $t5, '*', outloopFirstMoveplayer2
	addi $t4, $t4, -7
outloopFirstMoveplayer2:
	sb $t2, ($t4)
	li $v0, 3
	jr $ra
...
checkIf:
	...
	li $t7, 41
	slt $t5, $t7, $t4
	beq $t5, 1, checkVictoryforBlock
	add $t6, $t4, $s0
	lb $t7, ($t6)
	beq $t7, '*', continueCheckblock
checkVictoryforBlock:
	add $v0, $zero, $zero
	jal checkVictory
